...
class ViewController: UIViewController {
    ...
    func handleSuccessWithToken(_ publicToken: String, metadata: [String : Any]?) {
        ...
        vc.token = "access-sandbox-13ced9fb-faf2-4587-8e9e-6a6e610216bc"
    ...
    func presentPlaidLinkWithCustomConfiguration() {
        ...
        let linkConfiguration = PLKConfiguration(key: "7395161a82482ab6ab898bf37ce4bd", env: .sandbox, product: .auth)
    ...
    func presentPlaidLinkInUpdateMode() {
        ...
        let linkViewDelegate = self
        let linkViewController = PLKPlaidLinkViewController(publicToken: "7395161a82482ab6ab898bf37ce4bd", delegate: linkViewDelegate)
        if (UI_USER_INTERFACE_IDIOM() == .pad) {
            linkViewController.modalPresentationStyle = .formSheet
        }
        present(linkViewController, animated: true)
